...
def load_celeba(data_folder=data_folder):
	x_train = np.load(os.path.join(data_folder, 'celeba','train.npy'))
	x_test = np.load(os.path.join(data_folder, 'celeba', 'test.npy'))
